...
export const ui: Dict = {
  ...
  cityMapsLabHelp: {
    en: 'Preview maps + lore cinematics. New city = city intro. Drag XP or click a marker = enemy intro.',
    pt: 'Pré-visualiza mapas + cinemáticas de lore. Cidade nova = intro da cidade. Arrasta XP ou clica marcador = intro do inimigo.',
  },
  cineCityTag: { en: 'City chronicle', pt: 'Crónica da cidade' },
  cineEnemyTag: { en: 'Challenge', pt: 'Desafio' },
  cineSkip: { en: 'Skip', pt: 'Saltar' },
  cineContinue: { en: 'Continue', pt: 'Continuar' },
  cineNext: { en: 'Next', pt: 'Next' },
  cineReplayCity: { en: 'Replay city lore', pt: 'Replay lore cidade' },
  cineClickHint: {
    en: 'Click start, vassal or BOSS marker for lore. PLAY (bottom-right) = future video cinematic.',
    pt: 'Clica partida, súdito ou BOSS para ver lore. PLAY (canto inferior direito) = cinemática vídeo (futuro).',
  },
  mapStartPoint: { en: 'Start', pt: 'Partida' },
  cinePlayTitle: { en: 'Cinematic', pt: 'Cinemática' },
  cinePlaySlotAria: {
    en: 'Future cinematic video slot',
    pt: 'Espaço futuro do vídeo da cinemática',
  },
  cinePlaySlotHelp: {
    en: 'Video cinematic goes here later. Slot ready — no file yet.',
    pt: 'Vídeo da cinemática entra aqui depois. Slot pronto — ainda sem ficheiro.',
  },
  cinePlaySlotPath: {
    en: 'docs/assets/cinematics/…',
    pt: 'docs/assets/cinematics/…',
  },
  ...
  openGrimoire: { en: 'Open grimoire', pt: 'Abrir grimório' },
  closeGrimoire: { en: 'Close', pt: 'Fechar' },
  carriageParty: { en: 'Party carriage', pt: 'Carroça da party' },
  closeCarriage: { en: 'Close carriage', pt: 'Fechar carroça' },
  openCarriage: { en: 'Open carriage', pt: 'Abrir carroça' },
  carriageZoomHint: {
    en: 'Inside the carriage — tap a seated hero to open their sheet.',
    pt: 'Dentro da carroça — toca num herói sentado para abrir a ficha.',
  },
  ...
  campaignMap: { en: 'City map', pt: 'Mapa da cidade' },
  campaignMapHelp: {
    en: 'Pick map art that matches season/lore. Click the preview to place the selected landmark.',
    pt: 'Escolhe a arte do mapa que combine com a estação/lore. Clica no preview para colocar o marco selecionado.',
  },
  campaignMapArt: { en: 'Map art', pt: 'Arte do mapa' },
  campaignMapMismatch: {
    en: 'Warning: this art belongs to another city. Reset to match this month.',
    pt: 'Aviso: esta arte é de outra cidade. Repõe para bater com este mês.',
  },
  campaignMapClickHelp: {
    en: 'Select a landmark below, then click the map to move it.',
    pt: 'Seleciona um marco abaixo e clica no mapa para o mover.',
  },
  mapCityStart: { en: 'Party start landmark', pt: 'Marco de início da party' },
  landmarkName: { en: 'Landmark name', pt: 'Nome do marco' },
  resetLandmarks: { en: 'Reset landmarks', pt: 'Repor marcos' },
  resetMapArt: { en: 'Reset map art to this city', pt: 'Repor arte do mapa desta cidade' },
  campaignSeasonHelp: {
  ...
  campaignSeasonLocked: {
    en: 'Season is locked to the campaign month number (01→Jan … 12→Dec).',
    pt: 'Estação fica presa ao número do mês da campanha (01→jan … 12→dez).',
  },
  ...
  saveAdminHint: {
    en: 'Press Save to keep changes.',
    pt: 'Carrega Guardar para manter as alterações.',
  },
  saveAdminClean: {
    en: 'No unsaved changes',
    pt: 'Sem alterações por guardar',
  },
  saveAdminFloat: { en: 'Save', pt: 'Guardar' },
