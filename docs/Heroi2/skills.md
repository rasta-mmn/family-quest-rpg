...
# Skills de Melodia Errante

Nenhuma skill desbloqueada ainda. As skills são ganhas ao completar meses (400 XP) cujo upgrade da classe Bardo seja do tipo `skill`.
