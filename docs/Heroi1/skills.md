...
# Skills de Brasa de Ferro

Nenhuma skill desbloqueada ainda. As skills são ganhas ao completar meses (400 XP) cujo upgrade da classe Guerreiro seja do tipo `skill`.
